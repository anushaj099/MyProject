...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Sri Mouli Textiles Private Limited Issue to Department Data</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <center>
                ...
                <s:form action="Production" method="post" class="form-horizontal">
                    <table id="part1">

                        <td><s:hidden name="id" value="%{id}" /></td>
                        
                   <!--      <td><sj:datepicker name="ptp.date" id="i" maxDate="now" changeMonth="true" changeYear="true" label="Date" placeholder="Select date (dd-mm-yyyy)" displayFormat="dd-mm-yy" size="90" cssClass="lab" readonly="true"/> </td>-->
   ...
   <div class="col-sm-6 text-center">
         ...
         <s:else>
             <div class="col-sm-6 text-center">
                ...
                <s:form action="ProductionReal" enctype="multipart/form-data" method="post" onsubmit="return addAll()">
            ...
            <script>
                                ...
                                function addAll() {
                                    ...
                                    if ((x === '0.0' || y === '0.0' || z === '0.0') || (x === '0' || y === '0' || z === '0') || (($("#totalPrice1").val()).length === 0 || ($("#totalPrice2").val()).length === 0 || ($("#totalPrice3").val()).length === 0)) {
                                        alert("Please fill Issue to department Material Data");
                                        return false;
                                    }
