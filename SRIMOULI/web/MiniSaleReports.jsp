...
<link href="css/newcss.css" rel="stylesheet">
  ...
  <body style="background-color: #EEEEEE">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
               <h1 class="page-header">Sri Mouli Textiles Private Limited Sales Mini Statement Report</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <center>
     <s:form action="MiniSaleRtve" method="post" class="form-horizontal">
           <table>
               <tr> 
                   ...
                   <sj:datepicker  name="sd.date1" changeYear="true" maxDate="now" changeMonth="true" id="i1" readonly="true"  label="To Date"  size="90" cssClass="lab" displayFormat="dd-mm-yy"  placeholder="dd-mm-yyyy" requiredLabel="true" theme="simple"></sj:datepicker> 
