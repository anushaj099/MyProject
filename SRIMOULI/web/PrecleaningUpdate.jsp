<%-- 
    Document   : PrecleaningUpdate
    Created on : Mar 22, 2017, 4:17:41 PM
    Author     : Gayathri
--%>
...
<html>
    ...
    switch(newcell.childNodes[0].type) {
     ...
     function isNumberKey(el, evt)
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Sri Mouli Textiles Private Limited Issue to Precleaning Update</h1>
                </div>
            </div>
            <div class="row">
                <center>
                    <s:form action="precleaningUpdate" class="form-horizontal" method="post" onsubmit="return updateAll()">
                        <table>
  ...
  <tr > <td align="left">   <input type="button" value="Add Row"  class="btn btn-primary" onclick="addRow('one1')" onkeyup="myFunction()"/>   
                               ...
                               <table class="table table-bordered table-responsive  weight-table">      
                                    <s:iterator value="glist">
                                        <tr>
                                            <td style="width: 180px"><b>Total</b></td>
