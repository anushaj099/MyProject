<%-- 
    Document   : ProductionView
    Created on : Dec 26, 2016, 6:01:30 PM
    Author     : Gayathri
--%>
  ...
  <%--  <s:iterator value="ulist" var="myobj" >   
    ...
    <s:iterator value="ulist" status="stat" var="myobj"> 
         ...
         <div class="container">
                  <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sri Mouli Textiles Private Limited Issue to Department View</h1>
                    </div>
                </div>
               <div class="row">
                    <center>
        ...
        <table border="1" class="table table-bordered table-responsive">
            ...
            <s:iterator value="glist" status="rowstatus">
                ...
                <s:if test="#myobj.loginType == 'control'"> 
                  ...
                  <td>    <a href="productionEdit?id=<s:property value='id'/>&idpp=<s:property value='idpp'/>" data-toggle="tooltip" data-placement="bottom" title="Edit"> <img src="Images/edit.png" alt="images" /></a></td>

                    <td>    <a href="productionDelete?id=<s:property value='id'/>&id1=<s:property value='idpp'/>" data-toggle="tooltip" onclick="return confirm('Are You Sure ?')" data-placement="bottom" title="Delete"> <img src="Images/delete.png" alt="images" /></a></td>
                  </s:if>
                <s:else>
