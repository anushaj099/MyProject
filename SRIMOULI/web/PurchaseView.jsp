    ...
    <body style="background-color: #EEEEEE">
        <style type="text/css">
            ...
            <s:iterator value="ulist" var="myobj" >  
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sri Mouli Textiles Private Limited Purchase View </h1>
                    </div>
                </div>
                <!-- /.row -->
             ...
             <s:form action="purchaseview" method="post" class="form-horizontal">
                        <div class="tab1">
                            <table border="1" class="table table-bordered table-responsive">
                                ...
                                <s:iterator value="glist" status="rowstatus">
                                    <tr>
                                        ...
                                        <td><a href="purchaseEdit?id=<s:property value='id'/>&idp=<s:property value="idp"/>" data-toggle="tooltip" data-placement="bottom" title="Edit"> <img src="Images/edit.png" alt="images" /></a></td>
                                        <td><a href="purchaseDelete?id=<s:property value='id'/>&idp=<s:property value="idp"/>" data-toggle="tooltip" onclick="return confirm('Are You Sure ?')" data-placement="bottom" title="Delete"> <img src="Images/delete.png" alt="images" /></a></td>
                                        </s:if>
                                        <s:else>
