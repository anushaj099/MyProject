...
<link href="css/newcss.css" rel="stylesheet">
   ...
   <body style="background-color: #EEEEEE">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
               <h1 class="page-header">Sri Mouli Textiles Private Limited Purchase Main Statement Report</h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <center>
     <s:form action="PurchaseRtve" method="post" class="form-horizontal">
           <table>
               <tr> 
...
<%--                <td><s:hidden name="purchaseid" value="%{purchaseid}" /></td>
                    ...
                    <td> <sj:datepicker changeMonth="true" changeYear="true" name="pd.date" readonly="true" maxDate="true" id="i"  label="From Date"  size="80" cssClass="lab" displayFormat="dd-mm-yy"  placeholder="dd-mm-yyyy" requiredLabel="true" theme="simple"></sj:datepicker> </td>
                   <sj:datepicker changeMonth="true" changeYear="true" name="pd.date1" maxDate="now" id="i1" readonly="true"  label="To Date"  size="30" cssClass="lab" displayFormat="dd-mm-yy"  placeholder="dd-mm-yyyy" requiredLabel="true" theme="simple"></sj:datepicker> 
               </tr>
