<%-- 
    Document   : PrecleaningReports
    Created on : Mar 22, 2017, 3:51:45 PM
    Author     : Gayathri
--%>
    ...
    <%@include file="Upperpage3.jsp" %>  --%>
        <s:iterator value="ulist" status="stat" var="myobj"> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sri Mouli Textiles Private Limited Issue to Precleaning Report</h1>
                    </div>
                </div>
                <div class="row">
                    <center>
                <s:form action="precleaningrtve" method="post" class="form-horizontal">
                ...
                <s:iterator value="list" var="obj1" status="stat">
                    ...
                    <tr>
                            ...
                            <s:iterator value="list1" var="obj2">
                                <s:if test="#obj1.parentGdPrecleaning.idpr==#obj2.idpr">
