                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <s:if test="#myobj.loginType == 'godown'"> 
                                    ...
                                    <s:if test="%{abcd==11}">
                                        <a href="purchaseDashboard?id=<s:property value='id'/>" >Entry</a>
                                    </s:if> 

                                    <s:elseif test="%{abcd==12}">
                                        <a href="productionDashboard?id=<s:property value='id'/>" >Entry</a>
                                    </s:elseif>
                                    <s:elseif test="%{abcd==18}">
                                        <a href="precleaningDashboard?id=<s:property value='id'/>">Entry</a>
                                    </s:elseif>
                                    <s:elseif test="%{abcd==14}">
                                        <a href="wastageDashboard?id=<s:property value='id'/>" >Entry</a>
                                    </s:elseif>

                                    <s:if test="%{abcd==13}">
                                        <a href="saleDashboard?id=<s:property value='id'/>" >Entry</a>
                                    </s:if>
                                ...
                                <s:if test="#myobj.loginType == 'control'"> 
                                    ...
                                    <s:if test="%{abcd==5}">
                                        ...
                                        <s:if test="%{abcd==22}">
                                       <a href="dispatchDashboard?id=<s:property value='id'/>" >Entry</a> 
                                    </s:if>
                                    <s:if test="%{abcd==6}">
                            ...
                            <li>
                                <s:if test="#myobj.loginType == 'godown'">  
                                    <s:if test="%{abcd==11}">                            
                                        <ul class="nav navbar-nav navbar-right">
                                            <li class="dropdown">
                                                <a href="#" class="dropdown-toggle actived" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports</a>
                                    ...
                                    <s:if test="%{abcd==12}">
                                        <a href="productionreports?id=<s:property value='id'/>" class="active actived">Reports</a>
                                    </s:if>
                                   <s:if test="%{abcd==18}">
                                        <a href="precleaningreports?id=<s:property value='id'/>" class="active actived">Reports</a>
                                    </s:if>
                                    <s:if test="%{abcd==14}">
                                        <a href="wastagereports?id=<s:property value='id'/>" class="active actived">Reports</a>
                                    </s:if>
                                </s:if>
                                <s:if test="#myobj.loginType == 'control'">  
                                    <s:if test="%{abcd==11}">                            
                                    ...
                                    <s:if test="%{abcd==2}">
                                        <%--  <a href="drawingreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a> --%>

                                        <ul class="nav navbar-nav navbar-right">
                                            <li class="dropdown">
                                                <a href="#" class="dropdown-toggle active actived" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports</a>
                                                <ul class="dropdown-menu">
                                    ...
                                    <s:if test="%{abcd==3}">
                                        <%--   <a href="openendreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a> --%>
                                    ...
                                    <s:if test="%{abcd==4}">
                                        <a href="qualityreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a>
                                    </s:if>
                                    <s:if test="%{xyz==100}">
                                         <s:if test="%{abcd==5}">
                                        <a href="packingreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a>
                                    </s:if>
                                        
                                   <s:elseif test="%{abcd=22}">
                                          <a href="dispatchreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a>
                                  </s:elseif>
                                  </s:if> 
                                    <s:if test="%{abcd==6}">
                                        <a href="powerretrieve?id=<s:property value='id'/>" id="no" class="active actived">Reports</a>
                                    </s:if>
                                ...
                                <s:if test="#myobj.loginType == 'carding'">  
                                    <%-- <a href="cardingreports?id=<s:property value='id'/>" id="no" class="active actived">Reports</a> --%>
