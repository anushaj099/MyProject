                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <s:if test="#myobj.loginType == 'godown'">  
                                    <s:if test="%{abcd==11}">                            
                                        <a href="purchaseview?id=<s:property value='id'/>" id="no" class="active actived">View</a> 
                                    </s:if>
                                    <s:elseif test="%{abcd==13}">
                                        <a href="saleview?id=<s:property value='id'/>" class="active actived">View</a>
                                    </s:elseif>
                                    <s:if test="%{abcd==12}">
                                        <a href="productionview?id=<s:property value='id'/>" class="active actived">View</a>
                                    </s:if>
                                    <s:if test="%{abcd==18}">
                                        <a href="precleaningview?id=<s:property value='id'/>" class="active actived">View</a>
                                    </s:if>
                                    <s:if test="%{abcd==14}">
                                        <a href="wastageview?id=<s:property value='id'/>" class="active actived">View</a>
                                    </s:if>
                                </s:if>
                                <s:if test="#myobj.loginType == 'control'">  
                                    <s:if test="%{abcd==11}">                            
                                    ...
                                    <s:if test="%{abcd==1}">
                                        <a href="cardingview?id=<s:property value='id'/>" id="no" class="active actived">View</a> 
                                    </s:if>
                                    <s:if test="%{abcd==2}">
                                        <a href="drawingview?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                    </s:if>
                                    <s:if test="%{abcd==3}">
                                        <a href="openendview?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                    </s:if>
                                    <s:if test="%{abcd==4}">
                                        <a href="qualityview?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                    </s:if>
                                   <s:if test="%{xyz==100}">
                                        <s:if test="%{abcd==5}">
                                        <a href="packingview?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                    </s:if>
                                    <s:elseif test="%{abcd==22}">
                                        <a href="dispatchview?id=<s:property value='id'/>" id="no" class="active actived">View</a> 
                                    </s:elseif>
                                    </s:if>
                                    <s:if test="%{abcd==6}">
                                        <a href="powerView?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                    </s:if>
                                </s:if>       
                                ...
                                <s:if test="#myobj.loginType == 'drawing'"> 
                                    <a href="drawingviewid=<s:property value='id'/>" id="no" class="active actived">View</a>
                                </s:if>
                                <s:if test="#myobj.loginType == 'openend'"> 
                                    <a href="openendview?id=<s:property value='id'/>" id="no" class="active actived">View</a>
                                </s:if> 
