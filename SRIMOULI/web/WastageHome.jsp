...
text-align:center;
  ...
  function addRow(one1) {
   ...
   <s:iterator value="ulist" var="myobj" >   
     ...
     <s:form action="wastageinsert" method="post" class="form-horizontal">
        <table id="part1">
           
             <td><s:hidden name="id" value="%{id}" /></td>
          
            <td><sj:datepicker readonly="true"  maxDate="true" id="fromDate" name="form.date" changeMonth="true" changeYear="true"  label="Date "  size="90"  displayFormat="dd-mm-yy" cssClass="lab" placeholder="dd-mm-yyyy"/> </td>
          
            <td><s:select name="form.receipt" label="Receipt Number" id="i" cssClass="form-control" list="{'1','2','3','4','5'}" headerKey="" headerValue="Select Receipt.No" readonly="true"/></td>  
            <!--<td><s:textfield label="Receipt Number" size="80"  name="form.receipt" cssClass="form-control" id="i" placeholder="Enter Receipt.No"> </s:textfield></td>--> 
...
<!--     <div class="col-sm-6 text-center">
 ...
 <s:form action="wastageinsertReal" enctype="multipart/form-data" method="post" onsubmit="return addAll()">
...
<tr>
    <td><s:select name="form.variety" cssClass="form-control" list="productlist" headerKey="" headerValue="Select variety" theme="simple" readonly="true"/></td>  
<td><s:textfield name="form.noofBales" cssClass="form-control price3" placeholder="Enter No. of Bales" onkeypress="return isNumberKey(this,event)" id="bales"  theme="simple" ></s:textfield></td>
<td><s:textfield name="form.weight"  cssClass="form-control price" placeholder="Enter Weight"  onkeypress="return isNumberKey(this,event)" id="mix1" theme="simple" ></s:textfield></td>
</tr>
         <% } %>
</table>
...
<tr>
<td style="width: 305px"><b>Total</b></td>
<td><b><s:textfield  name="form.totalBales" id="totalPrice3"  placeholder="Enter Total Bales"  readonly="true" cssClass="form-control"  theme="simple" ></s:textfield> </b></td>
<td><b><s:textfield  name="form.totalWeight" id="totalPrice1" placeholder="Enter Total Weight" readonly="true" cssClass="form-control total" theme="simple"></s:textfield>   </b></td>
</tr> 
</table>
