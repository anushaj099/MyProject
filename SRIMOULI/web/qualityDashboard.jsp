<%-- 
    Document   : qualityDashboard
    Created on : Dec 22, 2016, 2:49:59 PM
    Author     : NSG
--%>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                                        <li>
                                            <a href="qualityDashboard?id=<s:property value='id'/>" class="actived">Dashboard</a>
                    </li>
                    <li>
      ...
      <ul class="nav navbar-nav navbar-right">
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="qualityprofile?id=<s:property value='id' /> " data-toggle="tooltip" data-placement="bottom" title="Edit">My Profile</a></li>
