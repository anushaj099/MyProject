...
import com.textile.manager.PrecleanManager;
 ...
 * @author ch.mounika
 */
public class PrecleaningAction extends ActionSupport {

    private ptcleaningDto ptp;
    private PrecleanManager pgm = new PrecleanManager();
    ...
    public ptcleaningDto getPtp() {
        return ptp;
    }

    public void setPtp(ptcleaningDto ptp) {
        this.ptp = ptp;
    }
    ...
    public String precleaningInsert() throws ParseException {
...
//                }
    ...
    public String PrecleaningInsertReal() throws ParseException {
        try {
        this.ulist = pgm.productionList(id);
        abcd = 18;
        superList = pgm.getSuperviser();
    ...
    public String updatePrecleaning() throws ParseException {
try {
        abcd = 18;
        this.ulist = pgm.productionList(getId());
    ...
    public String deletePrecleaning() {
        try {
        abcd = 18;
