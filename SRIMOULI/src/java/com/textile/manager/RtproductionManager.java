 ...
 * @author ch.mounika
 */
public class RtproductionManager {

    public List RetrivePtp(Pproduction pp) throws ParseException {

        List<ParentGdProduction> list = new ArrayList<>();
        List<ChildGdProduction> list1 = new ArrayList<>();
        ...
        try {
            ...
            if ((mix.equals("All")) && ((iss == 1) || (iss == 2) || (iss == 3)
                ...
                for (Object o : list) {
                    List l = null;
                    ParentGdProduction pq = (ParentGdProduction) o;
                    id = pq.getIdpp();
                    Criteria c1 = s.createCriteria(ChildGdProduction.class);
                    c1.add(Restrictions.eq("parentGdProduction.idpp", id));
                    l = c1.list();
                    s.flush();
                    s.clear();
                    list1.addAll(l);
                ...
                t.commit();
                s.close();
            } else if (mix.equals("All") || (mix.equals("-1") && issue.equals("-1"))) {
                Criteria c = s.createCriteria(ParentGdProduction.class);
                ...
                for (Object o : list) {
                    ...
                    ParentGdProduction pq = (ParentGdProduction) o;
                    id = pq.getIdpp();
                    Criteria c1 = s1.createCriteria(ChildGdProduction.class);
    ...
    public List productionList(Pproduction pp) {
    ...
    public List<ParentGdProduction> retrieveCtp(Pproduction pp) {
        String d = pp.getDate();
        String d1 = pp.getDate1();
        List list = null;
        try {
