        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/vsk-head.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><s:property value="fullName"/></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/vsk-head.jpg" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/vsk-head.jpg" class="img-circle" alt="Image">
        </div>
...
<!--        <li class="treeview">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
<!--               <li><a href="getgst?lid=<s:property value='lid'/>">Create GSTIN</a></li>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          <b> WELCOME TO  VENKATA SAI KRISHNA STONE CRUSHER </b>
      </h1>
    </section>
