...
<!--                <table id="two1" >
   ...
   <tr>
       <td style="width:19.5%;"> <s:select list="glist" id="tri" cssStyle="form-control" name="tdto.productDesc" cssClass="form-control" headerKey="" headerValue="Select Grade"  theme="simple"/></td>
       ...
       <td style="width:8.5%;"> <s:select id="uom" list="{'Cum','MTs','Units'}"  headerKey="" headerValue="Select" name="tdto.uom" cssClass="form-control" placeholder="select units"  />
   ...
   <td><s:textfield name="tdto.totalQty" size="8" id="totalqty" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
      
    <td><s:textfield name="tdto.totalValAtax" size="8" id="totalaftertax" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield name="tdto.totalValBtax" size="8" id="totalbeforetax"  cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td><s:textfield name="tdto.totalTaxval" size="8" id="totaltaxables" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   <td width="7%">&#X00A0;</td>
   <td><s:textfield name="tdto.totalCgstAmt" size="8" id="totcgstamt" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
    ...
    <td><s:textfield  size="8" id="totamt" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
      </tr>
