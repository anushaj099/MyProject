...
<!--                                            <tr>
                                          ...
                                          <s:iterator value="invlist"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize:none" readonly="true" value="%{billToAddress}" name="add1" cols="30" rows="4" />
                                                </td>
                                                <td style="border-color:white; padding-bottom: 50px;">
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize:none" readonly="true" value="%{shipAddress}" name="add2" rows="4" cols="30"/>
                                                </td>
                                        ...
                                        <table border="1" width="100%"  id="one1">
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2" style="text-align: center;width: 8%">Value After Tax /<s:property value="uom"/></th>
...
<tr>
    ...
    <table border="1" style="width:100%">
       ...
       <td><s:property value="gstReverseCharge"/></td>
              ...
              <tr>
                <td width="63%" colspan="2" rowspan="2" style="font-size: 12px;"><b>1.</b> We declare that this invoice shows the actual price of the goods described and that all are true and correct. <b>2.</b> We declare to the best of our knowledge and belief that particulars stated herein are true and correct and there is no additional consideration accuring to use either directly or indirectly in any manner other amounts indicated here. </td>
              <td colspan="2" style="font-size: 12px;">Ceritified that the particulars given above are true and correct</td>  
    </tr>
        <tr>
