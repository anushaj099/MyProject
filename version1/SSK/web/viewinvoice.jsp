                                    ...
                                    <table border="1" style="width:100%">
                                        ...
                                        <table border="0" style="width:100%" frame="box">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <s:property value="urInvoiceSerialNo"/>
                                                </td>
                                                <td style="border-color:white">
...
<!--<td><s:textfield   id="totalPrice4" cssClass="form-control"  placeholder="Enter Closing" readonly="true" theme="simple"></s:textfield></td>-->
 ...
 <label id="i"></label>
                ...
                <td>
                     ...
                     <td rowspan="2">
                  <s:textfield id="i" name="logindto.fullName" onkeypress="return isDecimalKey(event)" cssClass="form-control lable"/>
</td>
     </tr>
     <tr>
           <td style="border-color:white">
...
<tr>
    <table border="1" style="width:100%">
       ...
       <th style="text-align:center;" colspan="2">SAI VENKATA KRISHNA READY MIX INDUSTRY</th>
              ...
              <tr>
                  <td rowspan="4">
                      <s:textarea  value="%{termsConditions}" readonly="true" id="i" name="logindto.fullName" onkeypress="return isDecimalKey(event)" cssClass="form-control lable"/>
</td>
 ...
 <label id="i">Designation:</label>
                ...
                <td>
                    <s:property value="authDesign"/>
                        ...
                        <center>      <button id="s" style="margin-right: 250px;" onclick="myFunction('printablearea')" class="bfsbutton btn btn-primary btn-block btn-flat">Print Pay slip</button> </center>
