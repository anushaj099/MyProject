...
public class ChTaxIntra  implements java.io.Serializable {
    ...
    public ChTaxIntra(PrTaxIntra prTaxIntra, String productDesc, String hsnCode, Float qty, Float beforeTax, Float afterTax, Float rate, Float amount, Float taxableValue, Float cgRate, Float cgAmt, Float sgRate, Float sgAmt, Float chTotal, String uom) {
