...
<s:date name="%{new java.util.Date()}" format="dd/MM/yyyy" var="aaaa"/>
   ...
   <td style="padding-left: 130px;">
    ...
    <s:select id="charge" list="{'Yes','No'}"  headerKey="" headerValue="Select" name="tdto.reverseCharge" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Tax Is Payable On Reverse Charge"  />
        </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Date of Supply:</label>
      ...
      <div class="input-group-addon">
          <i class="fa fa-calendar"></i>
            ...
            <s:date name="%{new java.util.Date()}" format="dd/MM/yyyy" var="bbbbb"/>
      <s:textfield  value="%{bbbbb}" readonly="true" data-date-format="dd/mm/yyyy" name="tdto.dateOfSupply" onkeypress="return isDecimalKey(event)"  cssClass="form-control " placeholder="Select Date" size="50" />
       </div>
   </td>
   ...
   <td style="padding-left: 130px;">
    <label>Place of Supply</label>
        <s:textfield id="place" name="tdto.placeOfSupply" onkeypress="return isAlphaKey(event)" cssClass="form-control" placeholder="Enter place of supply" size="50" />
    </td>
...
<!--           <tr>
    ...
    <s:textfield id="mining"   name="tdto.mining" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Your Mining Number" size="50" />
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Way Bill No.:</label>
        <s:textfield id="waybill" name="tdto.waybill" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Your Way Bill Number" size="50" />
    </td>
    </div>
           </tr>
    <td><br/></td>    -->
   ...
   <td style="padding-left: 130px;">
    ...
    <td style="padding-left: 80px;">
    <label>Address:</label>
    <s:textarea id="raddr" name="tdto.billToAddress" onkeyup="checkInput2(this)" cssStyle="resize:none;"  rows="7" cols="20" cssClass="form-control recAdd" placeholder="Enter Receiver Address"/>
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
       <input type="checkbox" name="billingtoo1" onclick="FillBilling1(this.form)" id="chk-01"/>
    <label>Address: (Tick if Address is same)</label>
        <s:textarea id="caddr" name="tdto.shipAddress" onkeyup="checkInput2(this)" cssStyle="resize:none;"  rows="7" cols="20" cssClass="form-control conAdd" placeholder="Enter Consignee Address"/>
    </td>
    </div>
     </tr>
   ...
   <tr>
       ...
       <td width="7.7%"><s:textfield id="valu21"  onmousemove="totfreight()" name="tdto.afterTax" onkeypress="return isNumberKey(this,event)"   cssClass="form-control aftertax1 enbb valu21" theme="simple"></s:textfield></td>
    ...
    <tr>
       ...
       <td width="8.9%"> <s:select id="uom" disabled="true" list="{''}"  headerKey="" headerValue="Select" name="tdto.uom" cssClass="form-control" placeholder="select units"  />
       <td width="6%"><s:textfield id="qtyval"  readonly="true" name="tdto.qty" onkeypress="return isNumberKey(this,event)"    cssClass="form-control qtyval  qtyvals " theme="simple"></s:textfield></td>
       <td width="7.7%"><s:textfield id="valu31"  onmousemove="totfreight()" name="tdto.afterTax" onkeypress="return isNumberKey(this,event)"   cssClass="form-control aftertax2 enbb valu31" theme="simple"></s:textfield></td>
       <td width="8.9%"><s:textfield id="expprod2" readonly="true" name="tdto.beforeTax" onkeypress="return isNumberKey(this,event)"   cssClass="form-control expprod2" theme="simple"></s:textfield></td>
        <td width="9.1%"><s:textfield id="taxval12" readonly="true" name="tdto.taxableValue" onkeypress="return isNumberKey(this,event)"   cssClass="form-control taxval12 taxables " theme="simple"></s:textfield></td>
        <td width="6%"><s:textfield name="tdto.cgRate" readonly="true" value="2.5" onkeypress="return isNumberKey(this,event)"   cssClass="form-control cgst1 " theme="simple"></s:textfield></td>
       ...
       <td width="6%"><s:textfield name="tdto.sgRate" readonly="true" value="2.5" onkeypress="return isNumberKey(this,event)"   cssClass="form-control sgst1 " theme="simple"></s:textfield></td>
       ...
       <td width="9.1%"><s:textfield name="tdto.chTotal" readonly="true" id="totvalue1" onkeypress="return isNumberKey(this,event)"   cssClass="form-control totvalue1" theme="simple"></s:textfield></td>
   ...
   <tr>
     ...
     <td class="text-center"  style="text-align: right"><b>GST on Reverse Charge: &#X00A0;&#X00A0;&#X00A0;&#X00A0; </b></td> 
       ...
       <td><s:textfield name="tdto.gstReverseCharge" id="totalPrice1" cssClass="form-control reverse" theme="simple"></s:textfield></td>
   </tr>
   </table>
         &#x00A0;&#x00A0;&#x00A0;
            </div>  </div>  </div>  </div></div>
   ...
   <td style="padding-left: 80px;">
    ...
    <s:textarea id="tc" name="tdto.termsCond"  rows="10" cols="65" value="1. We declare that this invoice Shows the actual price of the goods  described and that all are true and correct.                                                   2. We declare to the best of our knowledge and belief that the particulars stated herein are true and correct and there is no additional consideration accuring to use either directly or indirectly in any manner other amounts indicated here. " readonly="true" cssClass="form-control"/>
              ...
              <table>
                  <tr><td style="padding-left: 470px;"><s:submit value="submit" cssClass="btn btn-primary" onclick="return validate1()" onsubmit="return validateform()" />   
        </td></tr>
