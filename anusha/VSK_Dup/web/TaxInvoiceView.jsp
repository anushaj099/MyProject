            ...
            <!-- Content Wrapper. Contains page content -->
                ...
                <!-- Content Header (Page header) -->
                 <s:iterator value="invlist">
                        ...
                        <a href="viewpdf?lid=<s:property value='lid'/>&invoiceNo=<s:property value='invoiceNo'/>"<span class="label label-success">View as PDF </span></a>
                ...
                <!-- Main content -->
                 <div id="printablearea">   
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
<div class="box" style="border-top: 0px solid black"> 
                                <s:form action="retrieveTaxInvoice" method="post" theme="css_xhtml">
                                    <table border="1" style="width:100%;">
                                       ...
                                       <table border="1" style="width:100%">
                                            <td align="center">
                                                 <img src="dist/img/saibaba.png" class="img-circle" alt="User Image">
                                            </td>
                                            <td align="center">
                                            <img src="dist/img/vsk-head1.jpg" class="img-circle" alt="User Image" style="margin-bottom: 7px;">
                                                 <h3 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;">TAX INVOICE</h3>
                                                <h4 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;">VENKATA SAI KRISHNA STONE CRUSHER</h4>
                                                <h5 style="font-family:arial,sans-serif;font-weight:bold;margin-bottom: 5px !important;margin-top: 5px !important;">GSTIN:37AAGFV7908J1ZM</h5>
                                                <h5 style="font-family:arial,sans-serif;padding-top: 0px;margin-bottom: 5px !important;margin-top: 5px !important;"><b>Works and Regd. Off:</b> 398/A1 A2,Narasaraopet Road,Opposite Dokiparru sub-station, <b>PERECHERLA,</b>Guntur Dist. (A.P).</h5>
                                                <h5 style="font-family:arial,sans-serif;padding-top: 0px;margin-bottom: 5px !important;margin-top: 5px !important;"><b>Mobile No</b>: 9849913085, <b>e-mail:</b> vsksc999@gmail.com</h5>
...
<!--                                            
                                             <tr>
                                                <td colspan="2" style="border-color:white">
                                                    ...
                                                    <label id="i">Mining Permit No.</label>
                                                </td>
                                                <td colspan="2">
                                                    <s:property value="mining"/>

                                                </td>
                                                <td style="border-color:white">

                                                    <label id="i">Way Bill No.</label>
                                                </td>
                                                <td>
                                                    <s:property value="waybill"/>
                                                </td>
                                          ...
                                          <s:iterator value="invlist"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize:none;" readonly="true" value="%{billToAddress}" name="add1" cols="30" rows="7" />
                                                </td>
                                                <td style="border-color:white; padding-bottom: 50px;">
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" cssStyle="resize:none;" readonly="true" value="%{shipAddress}" name="add2" rows="7" cols="30"/>
                                                </td>
                                        ...
                                        <tr>
                                        <table border="1" width="100%"  id="one1">
                                            <tr>
                                                ...
                                                <s:iterator value="tlist1">   <th rowspan="2" style="text-align: center;width: 7%">Qty&nbsp;<s:property value="uom"/></th>
                                               
                                               
                                                <th rowspan="2" style="text-align: center;width: 8%">Value Before Tax &nbsp;/<s:property value="uom"/></th>
                                                <th rowspan="2" style="text-align: center;width: 8%">Value After Tax &nbsp;/<s:property value="uom"/></th></s:iterator>
  ...
  <table border="0" frame="box" width="100%">
   ...
   <td width="6%" style="text-align: center; font-weight: bold"><s:property value="totalValBtax"/></td>
   ...
   <table border="1" width="100%">
        <tr>
         ...
         <td style="text-align: right"><s:property  value="getText('{0,number,###0.00}',{totalTaxval})" /></td>
        </tr>
        <tr>
        ...
        <td width="34.5%"><b>Add:CGST :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.5%</b></td> 
         <td style="text-align: right; padding-left: 9px;"><s:property  value="getText('{0,number,###0.00}',{totalCgstAmt})" /></td>
        </tr>
        <tr>
             <td><b>Bank Name:</b></td> 
         <td><s:property value="bankName"/></td>
         <td><b>Add:SGST :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2.5%</b></td> 
         <td style="text-align: right; padding-left: 9px;"><s:property  value="getText('{0,number,###0.00}',{totalSgstAmt})" /></td>
        </tr>
        <tr>
             <td><b>Bank Branch:</b></td> 
         <td><s:property value="bankBranch"/></td>
        <td width="34.5%"><b>Total Tax Amount:</b></td> 
         <td style="text-align: right"><s:property value="getText('{0,number,###0.00}',{totalCgstAmt+totalCgstAmt})"/></td>
        </tr>
        <tr>
            <td width="15%"><b>Bank A/C:</b></td> 
        <td><s:property value="bankAc"/></td>
        <td width="34.5%"><b>Add:Round Value :</b></td> 
         <td style="text-align: right; padding-left: 23px;"><s:property value="getText('{0,number,###0.00}',{round_val})"/></td>
   ...
   <tr>
        <td width="5%"><b>Bank IFSC:</b></td> 
         ...
         <td style="text-align: right"><s:property value="getText('{0,number,###0.00}',{totalInv})"/> </td>
    ...
    <s:iterator value="invlist">
      <table border="1" style="width:100%">
       ...
       <td><s:property value="gstReverseCharge"/></td>
        ...
        <td style="text-align:center" colspan="2"><b>For Venkata Sai Krishna Stone Crusher </b></td>     
     </tr>
     <tr>
...
<!--                                            <tr>
                                          ...
                                          <s:iterator value="invlist"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <s:textarea id="border" readonly="true" cssStyle="resize:none;" value="%{shipAddress}" name="add2" rows="7" cols="30"/>
                                                </td>
  ...
  <table border="0" frame="box" width="100%">
   ...
   <td width="6%" style="text-align: center; font-weight: bold"><s:property value="totalValBtax"/></td>
   <td width="6%" style="text-align: center; font-weight: bold"><s:property  value="getText('{0,number,###0.00}',{totalValAtax})" /></td>
   <td width="5.4%" style="text-align: center; font-weight: bold"><s:property value="totalTaxval"/></td>
   <td width="5.3%" style="text-align: center; font-weight: bold">&#X00A0;</td>
   <td width="7.5%" style="text-align: center; font-weight: bold"><s:property  value="getText('{0,number,###0.00}',{totalCgstAmt})" /></td>
    <td width="5.3%">&#X00A0;</td>
   <td width="7.5%" style="text-align: center; font-weight: bold"><s:property  value="getText('{0,number,###0.00}',{totalSgstAmt})" /></td>
                                ...
                                <s:form action="retrieveTaxInvoice" method="post" theme="css_xhtml">
                                    <table border="1" style="width:100%;">
                                       ...
                                       <table border="1" style="width:100%">
                                            ...
                                            <td align="center">
                                                 <img src="dist/img/vsk-head1.jpg" class="img-circle" alt="User Image" style="margin-bottom: 7px;"><br/>
                                                 <h3 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;">TAX INVOICE</h3>
                                                <h4 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;">VENKATA SAI KRISHNA STONE CRUSHER</h4>
                                                <h5 style="font-family:arial,sans-serif;font-weight:bold;margin-bottom: 5px !important;margin-top: 5px !important;">GSTIN:37AAGFV7908J1ZM</h5>
                                                <h5 style="font-family:arial,sans-serif;padding-top: 0px;margin-bottom: 5px !important;margin-top: 5px !important;"><b>Works and Regd. Off:</b> 398/A1 A2,Narasaraopet Road,Opposite Dokiparru sub-station, <b>PERECHERLA,</b>Guntur Dist. (A.P).</h5>
