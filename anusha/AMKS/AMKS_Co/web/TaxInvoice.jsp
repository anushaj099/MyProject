                              ...
                              var bankbr=document.getElementById("bankbr").value;
                                var ming=document.getElementById("ming").value;
                                  var way=document.getElementById("way").value;
                                   var valll=document.getElementById("valu21").value;
                                    var invcharge=document.getElementById("totalPrice1").value;
...
//                }
               ...
               //      alert(caddr);
                ...
                if(charge==='Yes')
                {
                    ...
                    if(invcharge==="" || invcharge===null)
                    {
                    alert("Please enter GST on Reverse Charge");
                    return false;
                    }
                }
...
<s:form action="insertTaxInvoice" theme="css_xhtml" onsubmit="return validateForm()">
   ...
   <td style="padding-left: 130px;">
    <label>Transport Mode:</label>
        <s:textfield id="trans" name="tdto.transportMode" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Transportation Mode" size="50" />
    </td>
    </div>
           </tr>
   ...
   <td style="padding-left: 130px;">
    ...
    <s:textfield id="ming"  name="tdto.mingPermitNo" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Mining Permit Number" size="50" />
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Way Bill No.:</label>
        <s:textfield id="way" name="tdto.wayBillNo" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Way Bill Number" size="50" />
    </td>
    </div>
           </tr>
     <td><br/></td>     
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Name:</label>
     <s:textfield id="rname"  name="tdto.billToName" onkeypress="return isDecimalKey(event)" cssClass="form-control recName" placeholder="Name Of Receiver" size="50" />
    </td>
   ...
   <td style="padding-left: 130px;">
    ...
    <label>Name: (Tick if Name is same)</label>
        <s:textfield id="cname" name="tdto.shipToName" onkeypress="return isDecimalKey(event)" cssClass="form-control conName" placeholder="Name Of Consignee" size="50" />
    </td>
    </div>
           </tr>
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Address:</label>
    <s:textarea id="raddr" name="tdto.billToAddress" cssStyle="resize:none"  rows="4" cols="20" cssClass="form-control recAdd" placeholder="Enter Receiver Address"/>
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
       <input type="checkbox" name="billingtoo1" onclick="FillBilling1(this.form)" id="chk-01"/>
    <label>Address: (Tick if Address is same)</label>
        <s:textarea id="caddr" name="tdto.shipAddress" cssStyle="resize:none"  rows="4" cols="20" cssClass="form-control conAdd" placeholder="Enter Consignee Address"/>
    </td>
    </div>
           </tr>
...
<!--                <table id="two1" >
   ...
   <tr>
        <td style="padding: 0;"> <s:select list="glist" id="tri" cssStyle="width:172px;" name="tdto.productDesc" cssClass="form-control gradesDes" headerKey="" headerValue="Select Grade"  theme="simple"/></td>
       ...
       <td width="8.9%"> <s:select id="uom" list="{'Cum','MTs'}"  headerKey="" headerValue="Select" name="tdto.uom" cssClass="form-control" placeholder="select units"  />
    ...
    <tr>
       ...
       <td><s:textfield name="tdto.hsnCode" readonly="true" value="2517" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price valu1 hsnCd" theme="simple"></s:textfield></td>
       <td width="8.9%"> <s:select id="uom" list="{''}" headerKey="" headerValue="Select" name="tdto.uom" cssClass="form-control" placeholder="select units"  />
   ...
   <td><s:textfield name="tdto.totalQty" size="4" id="totalqty" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   ...
   <td style="padding-left: 80px;">
       ...
       <label>Bank Name:</label>
                 <div>
                 <s:textfield id="bankname" name="tdto.bankName" value=""  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank Name" size="50" />
               
            </div>
        <label>Bank A/C:</label>
       
            <div>
                <s:textfield id="bankac" name="tdto.bankAc" value=""  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank A/C Number" size="50" />
               
            </div>
                 <label>Bank Branch:</label>
               <div>
                   <s:textfield id="bankbr" name="tdto.bankBranch" value=""   onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank Branch" size="50" />
  ...
  $(function () {
   ...
   function valus() {
                 ...
                 $('.cgstval').each(function () {
                        var aaa=document.getElementById("cgamt").value;
                        sum += Number($(this).val());
                        bb=sum+aaa
                     //  alert(sum);
                    });
   ...
   function decid(pp) {
    ...
    $('.weight-table tr').on('mousemove', function () {
             ...
             var boxtype1=$(this).find("#tri option:selected").text(); 
              ...
              var aaa=document.getElementById("valu1").value;
               ...
               if(boxtype1==='Grade' || boxtype1.length===0){
                      ...
                      // $(this).find(".enbb").attr('disabled',true);
...
//               if(aaa!==0)
//             {
//                   $(this).find(".valu21").attr('disabled',true);
//             }
                      ...
                      if( !(boxtype2==='Select' || boxtype2.length===0))  
{
  ...
  $('.qtyvals').mouseenter(function () {
                 ...
                 $('.cgstval').each(function () {
                       ...
                       bb += Number($(this).val());
                  //      alert(bb);
                   //     sum=parseFloat(bb)+parseFloat(aaa);
                     //  alert(sum);
                    });
