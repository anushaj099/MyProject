       ...
       var sgstval=document.getElementById("sgstval").value; 
        ...
        // alert(totamount);
         ...
         if(totamount)
         {
          ...
          var totl=parseFloat((aftax*0.05)+parseFloat(aftax));
       //   alert("sjfgjsadgfshf"+totl);
          $("#expprod").val(totl); 
          ...
          if(bjtax)
             ...
             var valtax=document.getElementById("taxval").value; 
          var vjtax=parseFloat(valtax)+parseFloat(aaa);
          if(vjtax)
               $("#totaltaxables").val(vjtax);   
...
//                }
                 ...
                 var way=document.getElementById("way").value;
                  if(ming=="" || ming==null){
                    alert("Mining Permit Number is must");
                    return false;
                }
                 if(way=="" || way==null){
                    alert("Way Bill Number is must");
                    return false;
                }
...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
   ...
   <td style="padding-left: 130px;">
    ...
    <s:textfield id="ming"  name="tdto.mingPermitNo" value="%{mingPermitNo}" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Mining Permit Number" size="50" />
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
    <label>Way Bill No.:</label>
        <s:textfield id="way" name="tdto.wayBillNo" value="%{wayBillNo}" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Way Bill Number" size="50" />
    </td>
    </div>
           </tr>
     <td><br/></td>  
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Name:</label>
    <s:textfield id="rname" value="%{billToName}"  name="tdto.billToName" onkeypress="return isDecimalKey(event)" cssClass="form-control recName" placeholder="Name Of Receiver" size="50" />
    </td>
   ...
   <td style="padding-left: 130px;">
    ...
    <s:textfield id="cname" value="%{shipToName}" name="tdto.shipToName" onkeypress="return isDecimalKey(event)" cssClass="form-control conName" placeholder="Name Of Consignee" size="50" />
    </td>
    </div>
           </tr>
    ...
    <div class="block">
        ...
        <td style="padding-left: 80px;">
    <label>Address:</label>
    <s:textarea id="raddr" name="tdto.billToAddress" cssStyle="resize:none" value="%{billToAddress}"  rows="4" cols="20" cssClass="form-control recAdd" placeholder="Enter Receiver Address"/>
    </td>
    <td>&#x00A0;</td>
   <td style="padding-left: 130px;">
       <input type="checkbox" name="billingtoo1" onclick="FillBilling1(this.form)" id="chk-01"/>
    <label>Address: (Tick if Address is same)</label>
    <s:textarea id="caddr" cssStyle="resize:none" name="tdto.shipAddress" value="%{shipAddress}"  rows="4" cols="20" cssClass="form-control conAdd" placeholder="Enter Consignee Address"/>
    </td>
    </div>
           </tr>
...
<!--                <table id="two1" >
   ...
   <tr>
      <td style="padding: 0;"><s:select list="glist" cssStyle="width:172px;" id="tri" value="%{productDesc}" name="tdto.productDesc" cssClass="form-control gradesDes"  headerKey="" headerValue="Select Grade" theme="simple"/></td>
       <td><s:textfield name="tdto.hsnCode" readonly="true"  value="2517" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price valu1 hsnCd" theme="simple"></s:textfield></td>
       <td width="8.9%"><s:select id="uom" list="{'Cum','MTs'}" value="%{uom}"  headerKey="" headerValue="Select" name="tdto.uom" cssClass="form-control" placeholder="select units"  />
       ...
       <td width="7.7%"><s:textfield id="valu1" name="tdto.afterTax" value="%{afterTax}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control valu1 aftertax" theme="simple"></s:textfield></td>
       ...
       <td width="8%"><s:textfield name="tdto.cgAmt" readonly="true" id="cgstval" onkeypress="return isNumberKey(this,event)" value="%{cgAmt}"   cssClass="form-control cgstval" theme="simple"></s:textfield></td>
       ...
       <td width="8%"><s:textfield name="tdto.sgAmt" readonly="true" id="sgstval" onkeypress="return isNumberKey(this,event)"  value="%{sgAmt}"  cssClass="form-control sgstval" theme="simple"></s:textfield></td>
       <td width="9.1%"><s:textfield name="tdto.chTotal" id="totval" readonly="true" onkeypress="return isNumberKey(this,event)"  value="%{chTotal}" cssClass="form-control totval" theme="simple"></s:textfield></td>
   ...
   <tr>
       <td style="padding: 0;"><s:textfield cssStyle="width:172px;" id="tri" readonly="true" value="%{productDesc}" name="tdto.productDesc" cssClass="form-control gradesDes" theme="simple"/></td>
       <td><s:textfield name="tdto.hsnCode" readonly="true"  value="" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price valu1 hsnCd" theme="simple"></s:textfield></td>
       <td width="8.9%"><s:textfield id="uom" readonly="true" name="tdto.uom" cssClass="form-control" />
       <td width="6%"><s:textfield id="qtyval" readonly="true" name="tdto.qty" value="%{qty}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control qtyval qtyvals" theme="simple"></s:textfield></td>
       <td width="7.7%"><s:textfield id="valu21" onmousemove="totfreight()" name="tdto.afterTax" value="%{afterTax}" onkeypress="return isNumberKey(this,event)"    cssClass="form-control enbb valu21" theme="simple"></s:textfield></td>
       <td width="8.9%"><s:textfield id="expprod1" readonly="true" name="tdto.beforeTax" value="%{beforeTax}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control expprod1" theme="simple"></s:textfield></td>
       <td width="9.1%"><s:textfield id="taxval11" readonly="true" name="tdto.taxableValue" value="%{taxableValue}" onkeypress="return isNumberKey(this,event)"   cssClass="form-control taxval1 taxables " theme="simple"></s:textfield></td>
       <td width="6%"><s:textfield name="tdto.cgRate" readonly="true" value="2.5" onkeypress="return isNumberKey(this,event)"  cssClass="form-control cgst "  theme="simple"></s:textfield></td>
       <td width="8%"><s:textfield name="tdto.cgAmt" readonly="true" id="cgamt" onkeypress="return isNumberKey(this,event)" value="%{cgAmt}"   cssClass="form-control  " theme="simple"></s:textfield></td>
       <td width="6%"><s:textfield name="tdto.sgRate" readonly="true" value="2.5" onkeypress="return isNumberKey(this,event)"  cssClass="form-control sgst " theme="simple"></s:textfield></td>
       <td width="8%"><s:textfield name="tdto.sgAmt" readonly="true" id="sgamt" onkeypress="return isNumberKey(this,event)"  value="%{sgAmt}"   cssClass="form-control  " theme="simple"></s:textfield></td>
       <td width="9.1%"><s:textfield name="tdto.chTotal" readonly="true" id="totvalue" onkeypress="return isNumberKey(this,event)"  value="%{chTotal}"   cssClass="form-control totvalue" theme="simple"></s:textfield></td>
   ...
   <tr>
      ...
      <tr>
   <td width="32.8%" class="text-center"><b>Total</b></td>  
   <td><s:textfield name="tdto.totalQty" value="%{totalQty}" size="4" id="totalqty" cssClass="form-control" readonly="true" theme="simple"></s:textfield></td>
   ...
   <td style="padding-left: 80px;">
       ...
       <label>Bank Name:</label>
                 <div>
                 <s:textfield id="bankname" name="tdto.bankName" value="%{bankName}"  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank Name" size="50" />
               
            </div>
        <label>Bank A/C:</label>
       
            <div>
                <s:textfield id="bankac" name="tdto.bankAc" value="%{bankAc}"  onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank A/C Number" size="50" />
               
            </div>
                 <label>Bank Branch:</label>
               <div>
                   <s:textfield id="bankbr" name="tdto.bankBranch" value="%{bankBranch}"   onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Bank Branch" size="50" />
