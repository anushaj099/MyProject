 ...
 <div class="box box-warning">          
                                ...
                                <s:form action="retrieveTaxInvoice" method="post" theme="css_xhtml">
                                    <table border="1" style="width:100%;">
                                       ...
                                       <table border="1" style="width:100%;">
<!--                                           <td align="center">
                                                <img style="padding-left:3px;padding-right:3px  !important" src="dist/img/log.jpg" alt="User Image">
                                            </td>-->
                                            <td align="center">
                                               ...
                                               <div style="line-height: -5px;">
                                                ...
                                                <h3 style="font-family:serif;font-weight:bold;margin-top: 5px;margin-bottom: -5px !important; ">Om Sai Stone Crusher</h3>
                                                <h4 style="font-family:serif;font-weight:bold;margin-top: 5px;margin-bottom: -3px !important;">9/37/1 Durga Street, Narasaraopet Bypass road, Perecherla Village,</h4>
                                                 <h4 style="font-family:serif;font-weight:bold;margin-top: 5px;margin-bottom: -3px !important;">Medikonduru Mandal, Guntur. Phone: 9030636799</h4>
                                                  <h3 style="font-family:serif;font-weight:bold;margin-top: 5px;margin-bottom: 2px !important">TAX INVOICE</h3>
...
<!--                                            <tr>
    ...
    <tr>
       ...
       <td style="text-align: center"><s:property  value="%{#total1}" /></td>
          ...
          <td colspan="2">&#X00A0;</td>
<!--          <td style="text-align: center"><s:property  value="hsnCode" /></td>
           <td style="text-align: center"><s:property  value="getText('{0,number,###0.0
                       0}',{qty})" /></td>-->
              <td style="text-align: center"><s:property  value="getText('{0,number,###0.00}',{afterTax})" /></td>
             <td style="text-align: center"><s:property  value="getText('{0,number,###0.00}',{beforeTax})" /></td>
           <td style="text-align: center"><s:property  value="getText('{0,number,###0.00}',{taxableValue})" /></td>   
...
<tr>
    ...
    <table border="1" style="width:100%">
       ...
       <td><s:property value="gstReverseCharge"/></td>
        ...
        <td style="text-align:center" colspan="2"><b>For Om Sai Stone Crusher</b></td>     
     </tr>
     <tr>
