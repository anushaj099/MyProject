    ...
    if (typeof history.pushState === "function") {
        ...
        <div class="login-box">
            ...
            <div class="login-logo">
             ...
             <CENTER><a href="#"><h1 style="margin-bottom: -1em;margin-top: -2em;">Om Sai Stone Crusher</h1></a></center>
            <!-- /.login-logo -->
              <div class="login-box">
            <div class="login-box-body">
                <p class="login-box-msg" style="font-size:1.25em;font-weight: bold; ">Please sign in</p>
