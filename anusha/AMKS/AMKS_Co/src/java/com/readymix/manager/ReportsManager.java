...
//    }
    ...
    public List PCList(TaxInvoiceDto form) throws ParseException{
         Session s = HibernateUtil.getSessionFactory().openSession();
        Transaction t = s.beginTransaction();
...
//        Date date1 = sf.parse(d1);
       ...
       String grades="";
        ...
        System.out.println("invoiceeeeeeeeee::"+num);
         Criteria c=s.createCriteria(PrTaxIntra.class);
             c.add(Restrictions.eq("billToName",bname));
        list=c.list();
             System.out.println("555555555 listttttttttttt"+list);
             int id=0;
             for(Object o:list){
                  List lst=null;
            ...
            Criteria c1 = s.createCriteria(ChTaxIntra.class);
             ...
             lst=c1.list();
              s.flush();
               ...
               System.out.println("chhhhh listtt"+list1);
        }
        else{
