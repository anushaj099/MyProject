        ...
        try {
         //   int iw=Math.round(tdto.getTotalInv());
          ...
          if (!validateUser(tdto)) {
            ...
            pc.setMingPermitNo(tdto.getMingPermitNo());
            pc.setWayBillNo(tdto.getWayBillNo());
         //   pc.setInvTot(iw);
            s.save(pc);
            t.commit();
            ...
            for (int i = 0; i < l1.size(); i++) {
                ...
                cc.setPrTaxIntra(pc);
                System.out.println("--------------------child--------------" + l1.get(i) + "&&&&&" + l5.get(i) + "((((((((("+l3+".*****"+l2.get(i)+"fghfh");
               // System.out.println("-------jkjhk***/-----------" + l2.get(i) + ")))))))))))" + l3.get(i) + "**" + l4.get(i));
                if(l1.get(i)!=null)
                cc.setProductDesc(l1.get(i));
                if(l2.get(i)!=null)
                cc.setHsnCode(l2.get(i));
                if(!"Frieght Charges".equals(l1.get(i))){
                if(i==0)
                cc.setQty(l3.get(i));
                }
                if(l4.get(i)!=null)
