...
<html>
  ...
  <title> Ready Mix Industry</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
         <div class="box box-info">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <s:submit value="Export To Excel" align="center" id="button" onclick="return check()" cssClass="btn btn-primary"  />
...
var fileNameToSaveAs = "DailyReport.csv";
