...
<html>
  ...
  <div class="box-header with-border">
    ...
    <s:textfield id="i" name="grade.grade1" onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter Grade" size="90" label="Grade"/>
         ...
         <td><br/></td>
              <div class="form-group has-feedback">
          <s:select id="i"  list="{'MTs','Units'}" name="grade.uom" headerKey="-1" headerValue="--Select Units of Measure--" onkeypress="return isDecimalKey(event)" cssClass="form-control"   label="Units of Measure"/>
        
      </div>
            <td><br/></td>
              <div class="form-group has-feedback">
    <s:textfield id="i" name="grade.basicRate" onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Basic Rate" size="90" label="Basic Rate"/>
                          ...
                          <tr>
                              ...
                              <td><s:property value="grade"/></td>
                               <td><s:property value="uom"/></td>
                                <td><s:property value="getText('{0,number,###0.00}',{basicRate})"/></td>
