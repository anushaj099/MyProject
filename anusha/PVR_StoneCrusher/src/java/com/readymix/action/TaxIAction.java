...
public class TaxIAction extends ActionSupport{
    private TaxInvoiceDto tdto;
     ...
     private int invoi;
         private List invlist,gradelist,uomList,rateList;
         private String words;
         private List quant1=new ArrayList(),quant2=new ArrayList();
    ...
    public List getQuant1() {
        return quant1;
    }

    public void setQuant1(List quant1) {
        this.quant1 = quant1;
    }
    ...
    public void setQuant2(List quant2) {
        this.quant2 = quant2;
    }
...
private List glist1;
                    ...
                    tlist12=new ArrayList();
                     tlist13=new ArrayList();
                      tlist14=new ArrayList();
                       ...
                       quant1=new ArrayList();
                       quant2=new ArrayList();
    ...
    public String retrieveGrades(){
        ...
        try{
            ...
            {
                Login l=(Login) o;
                System.out.println("sfdsfcdfsdvsfdvsfv"+l.getLType());
            }
            this.quant1=tim.getQuant1(id);
            this.quant2=tim.getQuant2();
            this.gradelist=tim.gradeRetrieve1();
             this.uomList=tim.getUomList();
              this.rateList=tim.getRateList();
    ...
    public void setId(int id) {
     ...
     public String editInvoice() {
          try {
            ...
            System.out.println("Invoice list isssssssss"+invlist);
            this.tlist=tim.invlistChild(getInvoiceNo());
             this.quant1=tim.getQuant1(getInvoiceNo());
              System.out.println("qqqq111111:::"+quant1);
            this.quant2=tim.getQuant2();
            this.gradelist=tim.gradeRetrieve1();
             this.uomList=tim.getUomList();
              this.rateList=tim.getRateList();
            this.glist=tim.getGrades();
              System.out.println("gradessss11111::"+glist);
             this.glist1=tim.getGrades2();
              System.out.println("gradessss2222222::"+glist1);
         //   this.gstlist=tim.getGstno();
           // this.gstlist=tim.getGstno();
          this.words=tim.getWords();
           this.tlist1=tlist.subList(0,1);
