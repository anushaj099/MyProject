...
public class LoginAction extends ActionSupport implements ServletRequestAware{
  ...
  private static int a,b,d,n,p,e,ma,mb,check;
  private int xyz=0;
    ...
    public String userView() {
     ...
     public String insertLogin(){
        ...
        System.out.println("dkjghdh---------------dkgkjdh2222222222222dgkhg" + ulist);
            ...
            if(!(logindto.getLoginid().length()==0 && logindto.getPassword().length()==0 && logindto.getDesignation().length()==0 && logindto.getFullName().length()==0 && logindto.getMobileNo().length()==0))
            {
                System.out.println("the jamesssss osfdslflklkjkjkj----------ksdjkfjdfsh-----------...........-->");
                ...
                else if (logindto.getDesignation().length() == 0) {
                ...
                else if (logindto.getFullName().length() == 0) {
              ...
              else if (logindto.getLType().length() == 0) {
         ...
         return "fail";
            ...
            else if((logindto.getLoginid().length()==0 && logindto.getPassword().length()==0 && logindto.getDesignation().length()==0 && logindto.getFullName().length()==0 && logindto.getMobileNo().length()==0)){
                check++;
                if (check % 2 != 0) {
                    addFieldError("logindto.fullName", "Please fill all fields");
               ...
               if (logindto.getLType().length() == 0) {
                ...
                if (logindto.getMobileNo().length() == 0) {
                 ...
                 p++;
                   ...
                   if (!umanager.validateUser2(logindto)) 
        {
         System.out.println("enterrrrrrrrrrrrrrrrrrrr");
         addFieldError("logindto.fullName", "LoginId with this Mobile number is already Exists");
         return "fail";
