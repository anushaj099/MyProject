...
public class ReportAction extends ActionSupport{
    ...
    private List ulist,glist,nlist,clist,gstlist,monsuplist,monsuplist2;
    ...
    public String dailyReport() {
     ...
     try {
            this.ulist = umaManager.dataRetrieve(getLid());
             ...
             System.out.println("the exception in reportspate in report action------------>"+e);
         }
        return "success";   
    }
