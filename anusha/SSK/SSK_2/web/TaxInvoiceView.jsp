                            ...
                            <div class="box" style="border-top: 0px solid black"> 
                                ...
                                <s:form action="retrieveTaxInvoice" method="post" theme="css_xhtml">
                                    <table border="1" style="width:100%;">
                                      ...
                                      <table border="1" style="width:100%">
                                            <td align="center">
                                                 <img src="dist/img/SSK_Logo.png" class="img-circle" alt="User Image">
                                            </td>
                                             <td align="center">
                                                 <img src="dist/img/ssk_head.jpg" class="img-circle" alt="User Image">
                                                <h4 style="font-family:arial,sans-serif;font-weight:bold;padding-top: 0px;margin-top: -5px;margin-bottom: -5px !important;">TAX INVOICE</h4>
                                                <h3 style="font-family:arial,sans-serif;padding-top: 0px;font-weight:bold;margin-top: 5px;margin-bottom: -5px !important;word-spacing: 1px;letter-spacing: 0.5px;"> SRI SAI KRISHNA STONE CRUSHER</h3>
                                                <h5 style="font-family:arial,sans-serif;padding-top: 0px;font-weight:bold;margin-bottom: -5px !important;margin-top: 5px !important;">GSTIN: 37AAVFS3232K1ZN, PAN: AAVFS3232K</h5>
                                                <h6 style="font-family:arial,sans-serif;padding-top: 0px;margin-bottom: -5px !important;margin-top: 5px !important;"><b>Works and Regd. Off: </b>D.No: 9/533, Perecherla Donka, Perecherla, Medikonduru Mandal, Guntur, Andhra Pradesh, 522005</h6>
                                                <h6 style="font-family:arial,sans-serif;padding-top: 0px;margin-bottom: 5px !important;margin-top: 5px !important;">Mobile No: 8886961913, Email Id: ssksc134@gmail.com</h6>
    ...
    <s:iterator value="invlist">
      <table border="1" style="width:100%">
       ...
       <td><s:property value="gstReverseCharge"/></td>
        ...
        <td style="text-align:center" colspan="2"><b>For Sri Sai Krishna Stone Crusher </b></td>     
     </tr>
     <tr>
