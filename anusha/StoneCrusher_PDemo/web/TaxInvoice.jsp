...
//                }
               ...
               else if(bankname==='ICICI Bank')
              {
               ...
               else if(bankname==='Punjab National Bank')
              {
                  var regex1 = /^PUNB\d{7}$/;
                  if(!(ifsc.match(regex1)))
                  {
...
<!--                <table id="two1" >
   ...
   <tr>
       ...
       <td><s:textfield name="tdto.hsnCode" readonly="true" value="XXXX" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price hsnCd" theme="simple"></s:textfield></td>
   ...
   <tr>
    ...
    <td style="padding-left: 80px;">
       ...
       <label>Bank Name:</label>
                 <div>
               <s:select id="bankname" name="tdto.bankName"  list="{'State Bank of India','HDFC Bank','ICICI Bank','Punjab National Bank','Axis Bank','Canara Bank','Andhra Bank'}"  onkeypress="return isAlphaKey(event)" cssClass="form-control"  headerKey="-1" headerValue="---Select Bank Name---" />
               
            </div>
        <label>Bank A/C:</label>
       
            <div>
                <s:textfield id="bankac" name="tdto.bankAc"   onkeypress="return isNumberKey(this,event)" cssClass="form-control" placeholder="Enter Bank A/C Number" size="50" />
               
            </div>
                 <label>Bank Branch:</label>
               <div>
                   <s:textfield id="bankbr" name="tdto.bankBranch"    onkeypress="return isAlphaKey(event)" cssClass="form-control" placeholder="Enter Bank Branch" size="50" />
               
            </div>
                
                <label>Bank IFSC:</label>
                 <div>
                     <s:textfield id="bankifsc" name="tdto.bankIfsc"   onkeypress="return isDecimalKey(event)" cssClass="form-control" placeholder="Enter IFSC Code" size="50" />
