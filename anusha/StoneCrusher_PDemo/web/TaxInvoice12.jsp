...
<!--                                                 <img src="dist/img/SVk_Head_1.png" class="img-circle" alt="User Image">-->
                                                ...
                                                <h3 style="font-family:arial,sans-serif;font-weight:bold;margin-top: -5px;margin-bottom: 5px !important;"> STONE CRUSHER INDUSTRY</h3>
                                                <h5 style="font-family:arial,sans-serif;font-weight:bold;margin-bottom: 5px !important;margin-top: 5px !important;">YOUR COMPANY ADDRESS.</h5>
...
<tr>
    ...
    <table border="1" style="width:100%">
       ...
       <td style="text-align: right; font-weight: bold;padding-right: 5px"><s:property value="getText('{0,number,###0.00}',{gstReverseCharge})"/></td>
          </tr>
              <tr>
                  <td width="55%" colspan="2" rowspan="2" style="font-size: 14px;">1. We declare that this invoice shows the actual price of the goods described and that all are true and correct. 2. We declare to the best of our knowledge and belief that particulars stated herein are true and correct and there is no additional consideration accuring to use either directly or indirectly in any manner other amounts indicated here. </td>
              <td colspan="2" style="font-size: 14px;">Ceritified that the particulars given above are true and correct</td>  
    </tr>
        <tr>
         
        <td style="text-align:center" colspan="2"><b>For Your Company Name </b></td>     
     </tr>
     <tr>
