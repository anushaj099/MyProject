...
<!--                <table id="two1" >
   ...
   <tr>
      ...
      <td><s:textfield name="tdto.hsnCode" value="%{hsnCode}" id="hsn" onkeypress="return isNumberKey(this,event)"   cssClass="form-control price" theme="simple"></s:textfield></td>
       ...
       <td width="8%"><s:select list="quant1"  id="qtyval" headerKey="%{qty}" value="%{qty}" headerValue="Select" name="tdto.qty"  onkeypress="return isNumberKey(this,event)"    cssClass="form-control qtyval qtyvals" theme="simple"></s:select>
        </td>
   ...
   <td style="padding-left: 80px;">
       ...
       <label>Bank Name:</label>
                 <div>
                 <s:select list="{'State Bank of India','HDFC Bank','ICICI Bank','Punjab National Bank','Axis Bank','Canara Bank','Andhra Bank'}" id="bankname" name="tdto.bankName" value="%{bankName}"  onkeypress="return isAlphaKey(event)" cssClass="form-control" placeholder="Enter Bank Name" />
